...
from main.views import home, solo_arrendadores, solo_arrendatarios, profile, edit_user, change_password, nuevo_inmueble, crear_inmueble
...
urlpatterns = [
    ...
    path('inmuebles/nuevo-inmueble/', nuevo_inmueble, name='nuevo_inmueble'),
